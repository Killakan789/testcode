...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add($a, [0 => 'ROLE_MANAGER'], NULL);
        $instance->add($a, [0 => 'IS_AUTHENTICATED_FULLY', 1 => 'ROLE_MANAGER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/customer/'), [0 => 'ROLE_MANAGER'], NULL);
